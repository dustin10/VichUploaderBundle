...
has a few options. They are as follows:

- `mapping` (required): The mapping specified in the bundle configuration to use
- `fileNameProperty` (required): The property of the class that will be filled with the file name
generated by the bundle 
- `fileRemoveProperty` (optional): The property of the class that will be used to mark the file for deletion when set to `true` 
...
Acme\DemoBundle\Entity\Product:
    image:
        ...
        fileremove_property: image_remove # optional
